    ...
    <footer className="bg-bg-alt border-t border-border mt-12">
      <div className="mx-auto max-w-7xl px-4 py-12 grid md:grid-cols-4 gap-8">
        <div className="md:col-span-2">
          <p className="font-display text-2xl tracking-wider-2 uppercase mb-3">FORGED AMERICAN</p>
          <p className="text-muted text-sm mb-6 max-w-md">No Apologies. Just Real.  Sign up for new drops and limited runs — no spam, just heat.</p>
