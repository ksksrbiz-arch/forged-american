    ...
    <footer className="bg-bg-alt border-t border-border mt-auto">
      <div className="mx-auto max-w-7xl px-4 py-12 grid md:grid-cols-4 gap-10">
        <div className="md:col-span-2">
          <h3 className="heading-mega text-2xl mb-3">FORGED AMERICAN</h3>
          <p className="text-muted text-sm max-w-md">Forged American is independently designed, printed, and shipped from the Mountain West. Every piece is built to outwork its price tag.</p>
        </div>
        <div>
