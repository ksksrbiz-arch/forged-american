    ...
    <header className="sticky top-0 z-40 bg-bg/95 backdrop-blur border-b border-border">
      <div className="mx-auto max-w-7xl px-4 h-16 flex items-center justify-between">
        <Link href="/" className="font-display text-2xl tracking-wider-2 uppercase">
          <span className="text-ink">FORGED</span><span className="text-accent ml-1">AMERICAN</span>
        </Link>
        ...
        <nav className="hidden md:flex items-center gap-7 text-sm font-display tracking-wider-2 uppercase">
          ...
          <Link href="/shop" className="hover:text-accent transition-colors">Shop</Link>
              <Link href={`/shop?category=${encodeURIComponent("Tees")}`} className="hover:text-accent transition-colors">TEES</Link>
              <Link href={`/shop?category=${encodeURIComponent("Hoodies")}`} className="hover:text-accent transition-colors">HOODIES</Link>
              <Link href={`/shop?category=${encodeURIComponent("Hats")}`} className="hover:text-accent transition-colors">HATS</Link>
              <Link href={`/shop?category=${encodeURIComponent("Stickers")}`} className="hover:text-accent transition-colors">STICKERS</Link>
