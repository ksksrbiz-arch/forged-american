      ...
      <div className="mx-auto max-w-7xl px-5 grid grid-cols-2 md:grid-cols-4 gap-3">
        <div className="group relative aspect-[4/5] md:aspect-auto md:h-80 overflow-hidden border border-border bg-card">
          ...
          <div className="relative z-10 h-full flex flex-col justify-between p-4 md:p-5">
            <h3 className="heading-mega text-2xl sm:text-3xl md:text-4xl text-ink whitespace-pre-line leading-none">NO
APOLOGIES</h3>
            <div>
              <div className="inline-block bg-accent text-white text-[10px] font-display tracking-wider-3 uppercase px-2.5 py-1 mb-1">
                ★ FORGED
              </div>
              <p className="font-body text-[11px] sm:text-xs md:text-sm text-ink/90 whitespace-pre-line leading-snug">Say it how it is.
Wear it like you mean it.</p>
        ...
        <div className="group relative aspect-[4/5] md:aspect-auto md:h-80 overflow-hidden border border-border bg-card">
          ...
          <div className="absolute inset-0 grain pointer-events-none" />
          <div className="relative z-10 h-full flex flex-col justify-between p-4 md:p-5">
            <h3 className="heading-mega text-2xl sm:text-3xl md:text-4xl text-ink whitespace-pre-line leading-none">BACKWOODS
BUILT</h3>
            <div>
              <div className="inline-block bg-accent text-white text-[10px] font-display tracking-wider-3 uppercase px-2.5 py-1 mb-1">
                ★ FORGED
              </div>
              <p className="font-body text-[11px] sm:text-xs md:text-sm text-ink/90 whitespace-pre-line leading-snug">Raised tough.
Built tougher.</p>
            </div>
          </div>
        </div>
        <div className="group relative aspect-[4/5] md:aspect-auto md:h-80 overflow-hidden border border-border bg-card">
          ...
          <div className="absolute inset-0 grain pointer-events-none" />
          <div className="relative z-10 h-full flex flex-col justify-between p-4 md:p-5">
            <h3 className="heading-mega text-2xl sm:text-3xl md:text-4xl text-ink whitespace-pre-line leading-none">LOUD &
PROUD</h3>
            <div>
              <div className="inline-block bg-accent text-white text-[10px] font-display tracking-wider-3 uppercase px-2.5 py-1 mb-1">
                ★ FORGED
              </div>
              <p className="font-body text-[11px] sm:text-xs md:text-sm text-ink/90 whitespace-pre-line leading-snug">If they can hear
you coming — you're
doing it right.</p>
            </div>
          </div>
        ...
        <div className="group relative aspect-[4/5] md:aspect-auto md:h-80 overflow-hidden border border-border bg-card">
          ...
          <div className="absolute inset-0 grain pointer-events-none" />
          <div className="relative z-10 h-full flex flex-col justify-between p-4 md:p-5">
            <h3 className="heading-mega text-2xl sm:text-3xl md:text-4xl text-ink whitespace-pre-line leading-none">REAL
AMERICA</h3>
            <div>
              <div className="inline-block bg-accent text-white text-[10px] font-display tracking-wider-3 uppercase px-2.5 py-1 mb-1">
                ★ FORGED
              </div>
              <p className="font-body text-[11px] sm:text-xs md:text-sm text-ink/90 whitespace-pre-line leading-snug">No spotlight.
No shortcuts.
Just real life.</p>
            </div>
          </div>
